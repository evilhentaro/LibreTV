// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["tyyszy","dyttzy", "bfzy", "ruyi","bfzy","tyyszy","ffzy","heimuer","zy360","iqiyi","wolong","hwba","jisu","dozy","mozhua","mdzy","mdzy","zuid","yinghua","baidu","wujin","wwzy","ikun"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["tyyszy","dyttzy", "bfzy", "ruyi","bfzy","tyyszy","ffzy","heimuer","zy360","iqiyi","wolong","hwba","jisu","dozy","mozhua","mdzy","mdzy","zuid","yinghua","baidu","wujin","wwzy","ikun"];
